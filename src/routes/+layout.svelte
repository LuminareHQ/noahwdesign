        ...
        <div class="flex flex-col border-2 w-full h-full justify-between">
            <div class="flex flex-col w-full p-4">
                ...
                <div class="flex flex-row w-full gap-4">
                    <a href="/" class="h-6 hover:underline w-[64px] whitespace-nowrap"
